...
│
├── reports/
│ ├── presentation.pdf # Презентация для бизнеса
...
| № | Урок | Описание |
|---|------|----------|
| 1 | **MDE — от экономики, а не от истории** | Исторический MDE (56%) завышен в 2.8 раз |
| 2 | **Мониторинг спасает эксперименты** | SRM-тест остановил невалидный эксперимент |
| 3 | **Стратификация — обязательна** | Позволяет проверить, что эффект реальный |
| 4 | **Power = 90% > 80%** | Надёжнее, хотя и требует больше выборки |
| 5 | **Аномалии нужно исследовать** | Неделя 9 оказалась техническим сбоем |
